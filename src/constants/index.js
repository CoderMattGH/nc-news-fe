const BASE_API_URL = `https://be-nc-news-4pai.onrender.com/api`;

const ARTICLES_API_URL = `${BASE_API_URL}/articles`;
const ARTICLE_BASE_API_URL = `${BASE_API_URL}/articles/`;
...
export default {BASE_API_URL, ARTICLES_API_URL, ARTICLE_BASE_API_URL, USER_BASE_API_URL,
    USERS_API_URL, COMMENTS_API_URL, ERR_MSG_NOT_LOGGED_IN, COMMENT_MAX_LENGTH};